...
private int mWidth,mHeight ;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        RectF rect = new RectF(- mWidth/2+ borderWidth/2,-mHeight/2+ borderWidth/2,mWidth/2- borderWidth/2,mHeight/2- borderWidth/2);
        canvas.drawArc(rect,135,270,false,outerPaint);
        canvas.drawArc(rect,135,270 * progress / 100,false,innerPaint);
